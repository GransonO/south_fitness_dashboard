...
export default class ActivityPosts extends Component {
  constructor(props) {
    super(props)
    this.state = {
      activeTab: "1",
          ...
          <Card>
            <CardHeader className="bg-transparent border-bottom">
              <div className="d-flex flex-wrap">
                <div className="mr-2">
                    <h5 className="card-title mt-1 mb-0">{this.props.text}</h5>
                </div>
              </div>
            </CardHeader>
                      ...
                      <TabPane className="show" tabId="1">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <div className="d-flex">
                              ...
                              <div className="align-self-center overflow-hidden mr-auto float-right">
                                <Link className="dropdown-item" to={ this.props.is_activity ? "/edit-activity?id=" + post.activity_id : "/edit-video?id=" + post.video_id }>
