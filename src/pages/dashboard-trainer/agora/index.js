...
class AgoraCanvas extends React.Component {
  ...
  componentWillMount() {
    let $ = this.props;
    console.log("This are the f Props ----------------------------- ", $);
  ...
  render() {
    ...
    const videoControlBtn =
      this.props.attendeeMode === "video" ? (
        ...
        >
          <i className={this.state.cameraState ? "ag-icon fas fa-video" : "ag-icon fas fa-video-slash"}></i>
        </span>
      ) : (
        ""
      );
    ...
    const audioControlBtn =
      this.props.attendeeMode !== "audience" ? (
        ...
        >
          <i className={this.state.micState ? "ag-icon fas fa-microphone-alt" : "ag-icon fas fa-microphone-alt-slash"}></i>
        </span>
      ) : (
        ""
      );
    ...
    const exitBtn = (
      <span
        ...
        title="Exit"
      >
        <i className="ag-icon fas fa-phone-slash"></i>
      </span>
    );
      ...
      <div id="ag-canvas" style={style}>
        <div className="ag-btn-group">
          ...
          {<span
            ...
            >
              <i className="ag-icon mdi mdi-monitor-eye"></i>
            </span>}
          {/*{hideRemoteBtn}*/}
        </div>
      </div>
